$(function () {
    ...
    var dataTable = $('#AuthorsTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(devNAS.blogging.authors.author.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                            ...
                            [
                                {
                                    text: l('Edit'),
                                    visible:
                                        abp.auth.isGranted('Blogging.Authors.Edit'),
                                ...
                                },
                                {
                                    text: l('Delete'),
                                    visible:
                                        abp.auth.isGranted('Blogging.Authors.Delete'),
                                    ...
                                    action: function (data) {
                                        devNAS.blogging.authors.author
